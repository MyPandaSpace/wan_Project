    ...
    <>
      ...
      <div className="home-container">
        ...
        <Link to="/Article" onClick={() => window.scrollTo(0, 0)}>
          <div id='column-event_Card_Collection' >
          <div className="collect-img-container-article"><img src="./src/images/Article_Bay/meditation_1.png" alt="" /></div>
            <small className="small-article">撰文 / 林郁虹醫師</small>
            <h2 className="h2-article">實踐正念冥想，改善情緒健康</h2>
        ...
        <Link to="/Article" onClick={() => window.scrollTo(0, 0)}>
          <div id='column-event_Card_Collection'>
          <div className="collect-img-container-article"><img src="./src/images/Article_Bay/meditation_2.png" alt="" /></div>
            <small className="small-article">撰文 / 林郁虹醫師</small>
            <h2 className="h2-article">實踐正念冥想，改善情緒健康</h2>
            <p className="p-article">透過正念冥想，我們能夠學會觀察當下的經驗，而不是被過去的回憶或未來的焦慮所困擾。這不僅有助於情緒的穩定，還能增進人際關係的理解與同理心。當我們專注於當下，我們的內心變得更加清晰，應對生活挑戰時也能更加冷靜和理智。</p>
          </div>
        ...
        <Link to="/Article" onClick={() => window.scrollTo(0, 0)}>
          <div id='column-event_Card_Collection'>
          <div className="collect-img-container-article"><img src="./src/images/Article_Bay/meditation_3.png" alt="" /></div>
            <small className="small-article">撰文 / 林郁虹醫師</small>
            <h2 className="h2-article">實踐正念冥想，改善情緒健康</h2>
            <p className="p-article">透過正念冥想，我們能夠學會觀察當下的經驗，而不是被過去的回憶或未來的焦慮所困擾。這不僅有助於情緒的穩定，還能增進人際關係的理解與同理心。當我們專注於當下，我們的內心變得更加清晰，應對生活挑戰時也能更加冷靜和理智。</p>
          </div>
        ...
        <Link to="/Article" onClick={() => window.scrollTo(0, 0)}>
          <div id='column-event_Card_Collection'>
          <div className="collect-img-container-article"><img src="./src/images/Article_Bay/meditation_4.png" alt="" /></div>
            <small className="small-article">撰文 / 林郁虹醫師</small>
            <h2 className="h2-article">實踐正念冥想，改善情緒健康</h2>
            <p className="p-article">透過正念冥想，我們能夠學會觀察當下的經驗，而不是被過去的回憶或未來的焦慮所困擾。這不僅有助於情緒的穩定，還能增進人際關係的理解與同理心。當我們專注於當下，我們的內心變得更加清晰，應對生活挑戰時也能更加冷靜和理智。</p>
          </div>
        ...
        <Link to="/Article" onClick={() => window.scrollTo(0, 0)}>
          <div id='column-event_Card_Collection'>
          <div className="collect-img-container-article"><img src="./src/images/Article_Bay/selfcare_1.png" alt="" /></div>
            <small className="small-article">撰文 / 林郁虹醫師</small>
            <h2 className="h2-article">實踐正念冥想，改善情緒健康</h2>
            <p className="p-article">透過正念冥想，我們能夠學會觀察當下的經驗，而不是被過去的回憶或未來的焦慮所困擾。這不僅有助於情緒的穩定，還能增進人際關係的理解與同理心。當我們專注於當下，我們的內心變得更加清晰，應對生活挑戰時也能更加冷靜和理智。</p>
          </div>
          ...
          <Link to="/Article" onClick={() => window.scrollTo(0, 0)}>
          <div id='column-event_Card_Collection'>
          <div className="collect-img-container-article"><img src="./src/images/Article_Bay/selfcare_2.png" alt="" /></div>
            <small className="small-article">撰文 / 林郁虹醫師</small>
            <h2 className="h2-article">實踐正念冥想，改善情緒健康</h2>
            <p className="p-article">透過正念冥想，我們能夠學會觀察當下的經驗，而不是被過去的回憶或未來的焦慮所困擾。這不僅有助於情緒的穩定，還能增進人際關係的理解與同理心。當我們專注於當下，我們的內心變得更加清晰，應對生活挑戰時也能更加冷靜和理智。</p>
          </div>
