      ...
      <div className="home-container">
        ...
        <div className="event">
          <div id='event-Type'>
            ...
            <Link to="/Event_Type3"><img id='event-Type3' src="./src/images/Event/event-Type3_hover.png" alt="" /></Link>
            <img style={{ marginLeft: '268px' }} src="./src/images/Event/btn_Select.png" alt="" />
          </div>
          <div id='row-event_Card'>
            <div id='column-event_Card'>
              <Link to="/Event_Detail"><img src="./src/images/Event/event_Image15.png" alt="" />
